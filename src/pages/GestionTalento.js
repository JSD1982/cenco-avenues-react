...
const GestionTalento = () => {
  const contextData = React.useContext(DataActionsContext);
  const dataItem = contextData.items && contextData.items.avenues[5];
  ...
  return (
    <>
      <header className="backgraund-header bkg-gestion-tealento fade-animate">
        <Nav active="gestion-de-talento" />
        ...
        <div className="container" style={{ zIndex: 20 }}>
          <div className="bread-crumb  d-flex justify-content-between">
            <ul className="d-flex">
              ...
              <li> / </li>
              <li>{langText.talentManagement.title}</li>
            </ul>
            <Link to="/">
              <span></span>
        ...
        <div className="container">
          ...
          >
            <div className="title-container-internal slide-animate-left">
              <h1>{langText.talentManagement.title}</h1>
              <p>{langText.talentManagement.description}</p>
            </div>
          </Parallax>
        </div>
      </header>
