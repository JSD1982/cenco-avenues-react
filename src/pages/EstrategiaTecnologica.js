...
const EstrategiaTecnologica = () => {
  const contextData = React.useContext(DataActionsContext);
  const dataItem = contextData.items && contextData.items.avenues[2];
  ...
  return (
    <>
      <header className="backgraund-header bkg-estrategia-tecnologica fade-animate">
        <Nav active="estrategia-tecnologica" />
        ...
        <div className="container" style={{ zIndex: 20 }}>
          <div className="bread-crumb  d-flex justify-content-between">
            <ul className="d-flex">
              ...
              <li> / </li>
              <li>{langText.technologyStrategy.title}</li>
            </ul>
            <Link to="/">
              <span></span>
        ...
        <div className="container">
          ...
          >
            <div className="title-container-internal slide-animate-left">
              <h1>{langText.technologyStrategy.title}</h1>
              <p>{langText.technologyStrategy.description}</p>
            </div>
          </Parallax>
        </div>
      </header>
...
export default EstrategiaTecnologica;
