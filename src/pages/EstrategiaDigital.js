...
const EstrategiaDigital = () => {
  const contextData = React.useContext(DataActionsContext);
  const dataItem = contextData.items && contextData.items.avenues[3];
  ...
  return (
    <>
      <header className="backgraund-header bkg-estrategia-digital fade-animate">
        <Nav active="estrategia-digital" />
        ...
        <div className="container" style={{ zIndex: 20 }}>
          <div className="bread-crumb  d-flex justify-content-between">
            <ul className="d-flex">
              ...
              <li> / </li>
              <li>{langText.digitalStrategy.title}</li>
            </ul>
            <Link to="/">
              <span></span>
        ...
        <div className="container">
          ...
          >
            <div className="title-container-internal slide-animate-left">
              <h1>{langText.digitalStrategy.title}</h1>
              <p>{langText.digitalStrategy.description}</p>
            </div>
          </Parallax>
        </div>
      </header>
