...
const CyberseguridadCompliance = () => {
  const contextData = React.useContext(DataActionsContext);
  const dataItem = contextData.items && contextData.items.avenues[0];
  ...
  return (
    <>
      <header className="backgraund-header bkg-ciberseguridad fade-animate">
        <Nav active="cyberseguridad-compliance" />
        ...
        <div className="container" style={{ zIndex: 20 }}>
          <div className="bread-crumb  d-flex justify-content-between">
            <ul className="d-flex">
              ...
              <li> / </li>
              <li>{langText.cybersecurity.title}</li>
            </ul>
            <Link to="/">
              <span></span>
        ...
        <div className="container">
          ...
          >
            <div className="title-container-internal slide-animate-left">
              <h1>{langText.cybersecurity.title}</h1>
              <p>{langText.cybersecurity.description}</p>
            </div>
          </Parallax>
        </div>
      </header>
...
export default CyberseguridadCompliance;
