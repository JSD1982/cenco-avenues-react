...
const CustomerCentricity = () => {
  ...
  const dataItem = contextData.items && contextData.items.avenues[1];
  ...
  return (
    <>
      <header className="backgraund-header bkg-customer-centricity fade-animate">
        <Nav active="customer-centricity" />
        ...
        <div className="container" style={{ zIndex: 20 }}>
          <div className="bread-crumb  d-flex justify-content-between">
            <ul className="d-flex">
              ...
              <li> / </li>
              <li>{langText.centricityConsumer.title}</li>
            </ul>
            <Link to="/">
              <span></span>
        ...
        <div className="container">
          ...
          >
            <div className="title-container-internal slide-animate-left">
              <h1>{langText.centricityConsumer.title}</h1>
              <p>{langText.centricityConsumer.description}</p>
            </div>
          </Parallax>
        </div>
      </header>
